    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="space-y-8">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600">全栈开发者 & 技术博主</p>
        </div>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-blue-50 rounded-lg">
                ...
                <p className="text-sm text-blue-600 mt-2">React, Vue, TypeScript</p>
              </div>
              <div className="text-center p-4 bg-green-50 rounded-lg">
                <h3 className="font-semibold text-green-800">后端</h3>
                <p className="text-sm text-green-600 mt-2">Node.js, Python, Java</p>
              </div>
              ...
              <div className="text-center p-4 bg-orange-50 rounded-lg">
                ...
                <p className="text-sm text-orange-600 mt-2">AWS, Docker, Kubernetes</p>
              </div>
              <div className="text-center p-4 bg-red-50 rounded-lg">
                <h3 className="font-semibold text-red-800">工具</h3>
                <p className="text-sm text-red-600 mt-2">Git, VS Code, Figma</p>
              </div>
              <div className="text-center p-4 bg-indigo-50 rounded-lg">
                <h3 className="font-semibold text-indigo-800">其他</h3>
                <p className="text-sm text-indigo-600 mt-2">GraphQL, REST API</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
              ...
              <div>
                <div className="text-2xl font-bold text-purple-600">2年</div>
                <div className="text-sm text-gray-600">写作经验</div>
              </div>
              <div>
